...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            'checkpoints/pth/simmim_pretrain__swin_base__img192_window6__800ep.pth'
        )),
    decode_head=dict(
        type='IG',
    ...
    disentangle_head=dict(
        ...
        loss_dig=dict(type='PixelLoss', loss_weight=1.0, loss_type='L2')))
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        datasetA=dict(
            ...
            data_root='data/nightcity-rain/train',
            img_dir='img',
            ann_dir='lbl',
            pipeline=[
                dict(type='LoadImageFromFile'),
    ...
    val=dict(
        type='NightcityDataset',
        data_root='data/nightcity-rain/val',
        img_dir='img',
        ann_dir='lbl',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
checkpoint_file = 'checkpoints/pth/simmim_pretrain__swin_base__img192_window6__800ep.pth'
fp16 = dict()
